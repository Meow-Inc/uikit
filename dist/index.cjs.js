...
var lightColors = __assign(__assign(__assign(__assign({}, bannerColorsLight), baseColors), additionalColors), { menuSelectedBackground: "#ef52d1", menuSelectedColor: "#fff", menuHoverBackground: "#eae6eaa3", accordianBackground: 'rgb(133 133 133 / 6%)', background: "#f7f5f7", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#280D5F", textDisabled: "#BDC2C4", textSubtle: "#7A6EAA", disabled: "#E9EAEB", gradients: {
