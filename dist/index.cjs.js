...
var leadingTrim = require('leading-trim');
...
var isFlex = function (_a) {
    var flex = _a.flex;
    return flex ? "display: flex; align-items: center;" : "display: block;";
};
var trimLeadingText = function (_a) {
    var fontSize = _a.fontSize, small = _a.small;
    var lineHeight = 1.5;
    var fSize = small ? 14 : fontSize ? parseInt(fontSize.substring(0, 2)) : 16;
    var heightMulSize = lineHeight * fSize;
    var cropAmount = heightMulSize / 2.5;
    var topCrop = +(cropAmount / 2.6).toFixed(2);
    var bottomCrop = +((cropAmount / 2) * 1.65).toFixed(2);
    var trimmed = leadingTrim.leadingTrim({
        lineHeight: 1.5,
        reference: {
            fontSize: small ? 14 : fSize || 16,
            lineHeight: 1.5,
            topCrop: topCrop,
...
}, styledSystem.space, styledSystem.typography, styledSystem.layout, trimLeadingText, isFlex);
Text.defaultProps = {
    color: "text",
    small: false,
    ellipsis: false,
...
var lightColors = __assign(__assign(__assign(__assign({}, bannerColorsLight), baseColors), additionalColors), { menuSelectedBackground: "#ef52d1", menuSelectedColor: "#fff", menuHoverBackground: "#eae6eaa3", accordianBackground: 'rgb(133 133 133 / 6%)', background: "#f7f5f7", backgroundDark: "#f7f5f7", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#280D5F", textDisabled: "#BDC2C4", textSubtle: "#7A6EAA", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign(__assign({}, bannerColorsDark), baseColors), additionalColors), { menuSelectedBackground: "#ef52d1", menuSelectedColor: "#fff", menuHoverBackground: "#ffffff0d", accordianBackground: '#00000024', secondary: "#9A6AFF", background: "#2d2d32", backgroundDark: "#2a262e", backgroundDisabled: "#3c3742", backgroundAlt: "#35303a", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
...
var StyledButton = styled__default['default'].button(templateObject_1$W || (templateObject_1$W = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  border-radius: .5rem;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  width: ", ";\n\n  ", "\n  ", "\n  ", "\n\n\n  ", "\n  ", "\n  ", "\n  ", "\n\n"], ["\n  align-items: center;\n  border: 0;\n  border-radius: .5rem;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  width: ", ";\n\n  ", "\n  ",
    ...
    "\n\n\n  ", "\n  ", "\n  ",
    "\n  ",
    "\n\n"])), getOpacity, function (props) { return props.fullWidth ? '100%' : undefined; }, getDisabledStyles, styledSystem.variant({
    prop: "scale",
...
var Button = function (props) {
    var startIcon = props.startIcon, endIcon = props.endIcon, external = props.external, className = props.className, fontSize = props.fontSize, isButtonMenu = props.isButtonMenu, isSelected = props.isSelected, isLoading = props.isLoading, disabled = props.disabled, children = props.children, rest = __rest(props, ["startIcon", "endIcon", "external", "className", "fontSize", "isButtonMenu", "isSelected", "isLoading", "disabled", "children"]);
    ...
    return (React__default['default'].createElement(StyledButton, __assign({ "$isLoading": isLoading, isButtonMenu: isButtonMenu, isSelected: isSelected, className: classNames.join(" "), disabled: isDisabled }, internalProps, rest),
        React.isValidElement(startIcon) &&
            React.cloneElement(startIcon, {
                mr: "0.5rem",
            }),
        React__default['default'].createElement(Text, { fontSize: fontSize }, children),
...
var Icon$1u = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "a", transform: "translate(-0.2 -0.02)" },
                React__default['default'].createElement("polygon", { points: "537.86 218.82 537.86 870.26 926.84 870.26 926.84 277.31 537.86 218.82", fill: "none" })),
            React__default['default'].createElement("clipPath", { id: "b", transform: "translate(-0.2 -0.02)" },
                React__default['default'].createElement("polyline", { points: "540 144.02 540 230.74 540 970.93 111.39 970.93 111.39 224.69", fill: "none" }))),
        React__default['default'].createElement("ellipse", { cx: "539.82", cy: "539.99", rx: "539.82", ry: "539.99", fill: "#ef52d1" }),
        React__default['default'].createElement("g", { "clip-path": "url(#a)" },
            React__default['default'].createElement("path", { d: "M195.7,377.39c0-58.59,34.41-84.63,76.26-84.63,20.46,0,35.34,5.58,49.29,18.6,26-13.95,55.8-18.6,83.7-18.6,53.94,0,98.58,13,133,38.13,34.41-25.11,80-38.13,133.92-38.13,132.06,0,209.25,75.33,209.25,207.39V679.64c0,61.38-33.48,88.35-75.33,88.35-42.78,0-76.26-27-76.26-88.35V502a57.35,57.35,0,0,0-57.66-57.66c-30.69,0-55.8,23.25-57.66,53V679.64C614.2,741,580.72,768,538.87,768c-42.78,0-76.26-27-76.26-88.35V502A57.35,57.35,0,0,0,405,444.35c-30.69,0-55.8,23.25-57.66,53V679.64c0,58.59-34.41,89.28-74.4,89.28-44.64,0-75.33-23.25-77.19-88.35Z", transform: "translate(-0.2 -0.02)", fill: "#fff" })),
        React__default['default'].createElement("g", { "clip-path": "url(#b)" },
            React__default['default'].createElement("path", { d: "M884,680.34c-1.86,65.1-32.55,88.35-77.19,88.35-40,0-74.4-30.69-74.4-89.28V497.13c-1.86-29.76-27-53-57.66-53a57.35,57.35,0,0,0-57.66,57.66V679.41c0,61.38-33.48,88.35-76.26,88.35-41.85,0-75.33-27-75.33-88.35V497.13c-1.86-29.76-27-53-57.66-53a57.35,57.35,0,0,0-57.66,57.66V679.41c0,61.38-33.47,88.35-76.26,88.35-41.84,0-75.32-27-75.32-88.35V499.92c0-132.06,77.19-207.39,209.24-207.39,53.94,0,99.51,13,133.92,38.13,34.41-25.11,79-38.13,133-38.13,27.9,0,57.66,4.65,83.7,18.6,14-13,28.83-18.6,49.29-18.6,41.85,0,76.26,26,76.26,84.63Z", transform: "translate(-0.2 -0.02)", fill: "#fff" })),
        React__default['default'].createElement("rect", { x: "538.18", y: "329.56", width: "3.27", height: "2.5", transform: "translate(287.19 -249.83) rotate(35)", fill: "#fff" })));
};
...
var Icon$1l = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { x: "0px", y: "0px" }),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("ellipse", { cx: "9.5732422", cy: "12.781208", rx: "1.15625", ry: "1.40625" }),
            React__default['default'].createElement("ellipse", { cx: "13.6669922", cy: "12.781208", rx: "1.15625", ry: "1.40625" })),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { fill: "none", d: "M5.9699998,15.0100002c0.0400004,0.1399994,0.1000004,0.2699995,0.1700001,0.4099998v0.0100002" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path",
100002l0.1399994,0.5299997v0.0100002c0,0.0199995,0.0100002,0.0299997,0.0100002,0.0500002\n      \t\t\tc0.0100002,0.0699997,0.0200005,0.1399994,0.0200005,0.21c0.0199986,0.0899992,0.0299988,0.1899996,0.039999,0.29\n      \t\t\tc0,0.0599995,0,0.1199999,0.0100002,0.1799994c0.0100002,0.0500002,0.0100002,0.1100006,0.0100002,0.1700001\n      \t\t\tc0,0.1599998-0.0100002,0.3100004-0.0300007,0.4700003c-0.0100002,0.1199999-0.0200005,0.2299995-0.039999,0.3500004\n      \t\t\tc-0.0100002,0.0099993-0.0100002,0.0199995-0.0100002,0.0299997c-0.0100002,0.0199995-0.0100002,0.0500002-0.0100002,0.0699997\n      \t\t\tc0,0.0100002,0,0.0200005-0.0100002,0.0299997C17.4500008,14.5,17.3799992,14.7600002,17.2700005,15.0100002\n      \t\t\tc-0.0400009,0.1399994-0.1000004,0.2699995-0.1700001,0.4099998c0,0.0100002-0.0100002,0.0199995-0.0100002,0.0299997\n      \t\t\tc-0.0699997,0.1400003-0.1499996,0.2799997-0.2299995,0.4099998C16.6900005,16.1299992,16.5,16.3799992,16.2900009,16.6200008\n      \t\t\tc-0.1100006,0.1199989-0.2200012,0.2399998-0.3400011,0.3499985c-0.1099997,0.1100006-0.2200003,0.210001-0.3400002,0.2900009\n      \t\t\tc-0.0899992,0.0799999-0.1999998,0.1599998-0.2999992,0.2299995c-0.2700005,0.1900005-0.5500002,0.3600006-0.8400002,0.5\n      \t\t\tC14.4499998,18,14.4200001,18.0100002,14.3999996,18.0200005c-0.1499996,0.0699997-0.2999992,0.1399994-0.4499998,0.1999989\n      \t\t\tc-0.0599995,0.0200005-0.1300001,0.0400009-0.1899996,0.0600014c-0.1199999,0.039999-0.2399998,0.0799999-0.3600006,0.1199989\n      \t\t\tc-0.1099997,0.0300007-0.2199993,0.0500011-0.3299999,0.0699997c-0.0799999,0.0200005-0.1599998,0.0400009-0.2399998,0.0600014\n      \t\t\tc-0.3900003,0.0699997-0.8000002,0.1099987-1.21,0.1099987c-0.4200001,0-0.8199997-0.039999-1.21-0.1099987h-0.0100002\n      \t\t\tC10.21,18.4899998,10.0100002,18.4500008,9.8299999,18.3999996C9.71,18.3600006,9.5900002,18.3199997,9.4799995,18.2800007\n      \t\t\tC9.4099998,18.2600002,9.3500004,18.2399998,9.29,18.2199993c-0.1599998-0.0599995-0.3100004-0.1299992-0.4499998-0.1999989\n      \t\t\tC8.8100004,18.0100002,8.79,18,8.7700005,17.9899998c-0.1400003-0.0699997-0.2800007-0.1399994-0.4200001-0.2199993\n      \t\t\tc-0.1100006-0.0699997-0.2200003-0.1400013-0.3200006-0.210001C8,17.5400009,7.98,17.5300007,7.9499998,17.5100002\n      \t\t\tc-0.1099997-0.0799999-0.2199998-0.1599998-0.3299999-0.25c-0.0899997-0.0599995-0.1799998-0.1300011-0.2599998-0.210001\n      \t\t\tl0.0099998-0.0099983" }))),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d:
.7169189,0.0413818,1.0544434,0.1035767\n      \t\tc0.0100098,0,0.0100098,0,0.0100098,0l0.0223999,0.0057983c0.0007324,0.0014038,0.0042114,0,0.0042114,0.0042114\n      \t\tl0.317688,0.0794067l0.4257202,0.1105957c0.0099487,0,0.0099487,0,0.0099487,0\n      \t\tc0.0009155-0.0002441,0.0018311-0.0007324,0.0027466-0.0009766l0.0039062,0.0009766h0.0100098\n      \t\tC14.1966553,7.98,14.2766113,7.9499707,14.3566284,7.9099927c0.0800171-0.0300293,0.1600342-0.0800171,0.2299805-0.1400146\n      \t\tc0.25-0.2000122,0.5100098-0.3900146,0.7800293-0.5700073c0.2600098-0.1699829,0.539978-0.3299561,0.8099976-0.4799805\n      \t\tc0.6258526-0.3369861,1.2375641-0.5960345,1.7390804-0.7834239c0.1728344-0.0645781,0.3697033,0.0396376,0.4066334,0.2204084\n      \t\tc0.1585503,0.7760987,0.1584606,1.6096277,0.0976334,2.3830223c-0.1300049,1.5100098-0.5199585,2.75-0.5299683,2.7799683\n      \t\tc-0.0200195,0.0599976-0.0300293,0.1199951-0.0400391,0.1799927c0.0090332,0.0247803,0.0108643,0.0515747,0.019165,0.0765991\n      \t\tc-0.0004883,0.0048828-0.0020142,0.0084229-0.0025024,0.0134277l0.1400146,0.539978\n      \t\tc0.0167236,0.0836792,0.0209351,0.1763916,0.0334473,0.2636108c0.0266113,0.1906128,0.0515137,0.3814087,0.0543213,0.5775146\n      \t\tc0.0001221,0.0196533,0.0021973,0.0392456,0.0021973,0.0588989c0,0.2893066-0.0287476,0.5706177-0.0782471,0.8453979\n      \t\tC18.0139771,13.9001656,18.010498,13.92519,18.0056763,13.9498482z" })),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("ellipse", { cx: "10.0732422", cy: "12.1982002", rx: "1.15625", ry: "1.40625" }),
            React__default['default'].createElement("ellipse", { cx: "14.1669922", cy: "12.1982002", rx: "1.15625", ry: "1.40625" }),
            React__default['default'].createElement("path", { d: "M12.9414062,13.6952705H11.359375c-0.1523438,0-0.2919922,0.0849609-0.375,0.2285156\n      \t\tc-0.0976562,0.1699219-0.0976562,0.3818359,0,0.5507812l0.1572266,0.2714844\n      \t\tc0.2265625,0.390625,0.6035156,0.6240234,1.0107422,0.6240234c0.0019531,0,0.0039062,0,0.0068359,0\n      \t\tc0.4111328-0.0029297,0.7900391-0.2412109,1.0146484-0.6396484l0.1464844-0.2607422\n      \t\tc0.0947266-0.1699219,0.0927734-0.3798828-0.0058594-0.5488281C13.2324219,13.7792549,13.0927734,13.6952705,12.9414062,13.6952705\n      \t\tz" }))));
};
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 1080 1080" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "a" },
                React__default['default'].createElement("polygon", { points: "538.782 262.893 538.782 831.495 877.262 831.495 877.262 313.944 538.782 262.893", fill: "none" })),
            React__default['default'].createElement("clipPath", { id: "b" },
                React__default['default'].createElement("polyline", { points: "539.5 197.71 539.5 273.406 539.5 919.466 166.534 919.466 166.534 268.125", fill: "none" }))),
        React__default['default'].createElement("ellipse", { cx: "540.0241", cy: "537.0111", rx: "539.8221", ry: "539.9889", fill: "#ef52d1" }),
        React__default['default'].createElement("g", { "clip-path": "url(#a)" },
            React__default['default'].createElement("path", { d: "M241.0524,401.3c0-51.1387,29.9425-73.8673,66.3586-73.8673,17.8035,0,30.7515,4.87,42.89,16.2348,22.6583-12.1758,48.5542-16.2348,72.8321-16.2348,46.9362,0,85.78,11.3643,115.7226,33.281,29.9416-21.9167,69.5945-33.281,116.5307-33.281,114.9135,0,182.0811,65.75,182.0811,181.0157V665.1117c0,53.5744-29.1327,77.1145-65.5488,77.1145-37.2258,0-66.3585-23.54-66.3585-77.1145v-155.04a49.9834,49.9834,0,0,0-50.1738-50.3272c-26.7049,0-48.5542,20.2933-50.173,46.2686v159.099c0,53.5744-29.1327,77.1145-65.5487,77.1145-37.2259,0-66.3586-23.54-66.3586-77.1145v-155.04a49.9833,49.9833,0,0,0-50.173-50.3272c-26.7057,0-48.555,20.2933-50.1738,46.2686v159.099c0,51.1392-29.9417,77.9259-64.74,77.9259-38.8439,0-65.5488-20.2933-67.1676-77.1144Z", fill: "#fff" })),
        React__default['default'].createElement("g", { "clip-path": "url(#b)" },
            React__default['default'].createElement("path", { d: "M838.8024,665.8274c-1.6188,56.821-28.3237,77.1136-67.1675,77.1136-34.7981,0-64.74-26.7868-64.74-77.926V505.9165c-1.6189-25.9753-23.4682-46.2687-50.1739-46.2687a49.9834,49.9834,0,0,0-50.173,50.3273v155.04c0,53.5744-29.1326,77.1145-66.3585,77.1145-36.4161,0-65.5487-23.54-65.5487-77.1145V505.9165c-1.6188-25.9753-23.4681-46.2687-50.173-46.2687a49.9835,49.9835,0,0,0-50.1738,50.3273v155.04c0,53.5744-29.1327,77.1145-66.3586,77.1145-36.4161,0-65.5487-23.54-65.5487-77.1145V508.3517c0-115.2655,67.1675-181.0156,182.0811-181.0156,46.9362,0,86.589,11.3643,116.5307,33.281,29.9425-21.9167,68.7863-33.281,115.7225-33.281,24.278,0,50.1739,4.059,72.8321,16.2347,12.139-11.3643,25.0869-16.2347,42.89-16.2347,36.416,0,66.3585,22.7286,66.3585,73.8673Z", fill: "#fff" })),
        React__default['default'].createElement("rect", { x: "537.6806", y: "359.6789", width: "3.2712", height: "2.498", transform: "translate(304.5721 -244.0731) rotate(35.0017)", fill: "#fff" })));
};
...
var templateObject_1$S, templateObject_2$o, templateObject_3$c, templateObject_4$9;
...
var InactiveButton = styled__default['default'](Button)(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  background-color: transparent;\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n  > div {\n    color: ", "!important;\n  }\n"], ["\n  background-color: transparent;\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n  > div {\n    color: ", "!important;\n  }\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
    return (variant === variants$4.PRIMARY ? theme.colors.textSubtle : theme.colors.textSubtle);
});
...
var Container$6 = styled__default['default'].div(templateObject_2$l || (templateObject_2$l = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent$1, DropdownContent$1);
...
var templateObject_1$w, templateObject_2$h, templateObject_3$b;
...
var templateObject_1$s, templateObject_2$f, templateObject_3$a, templateObject_4$8, templateObject_5$6, templateObject_6$1, templateObject_7$1;
...
var templateObject_1$r, templateObject_2$e, templateObject_3$9, templateObject_4$7, templateObject_5$5;
...
var bounce = styled.keyframes(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  from, 20%, 53%, 80%, to {\n    transform: translate3d(0,0,0);\n  }\n\n  40%, 43% {\n    transform: translate3d(0, -30px, 0);\n  }\n\n  70% {\n    transform: translate3d(0, -15px, 0);\n  }\n\n  90% {\n    transform: translate3d(0,-4px,0);\n  }\n"], ["\n  from, 20%, 53%, 80%, to {\n    transform: translate3d(0,0,0);\n  }\n\n  40%, 43% {\n    transform: translate3d(0, -30px, 0);\n  }\n\n  70% {\n    transform: translate3d(0, -15px, 0);\n  }\n\n  90% {\n    transform: translate3d(0,-4px,0);\n  }\n"])));
var shadow = styled.keyframes(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  from, 20%, 53%, 80%, to {\n    transform: scale(0.8);\n    opacity: 1;\n  }\n\n  40%, 43% {\n    transform: scale(1.3);\n    opacity: 0.4;\n  }\n\n  70% {\n    transform: scale(1.2);\n    opacity: 0.7;\n  }\n\n  90% {\n    transform: scale(1.1);\n    opacity: 0.8;\n  }\n"], ["\n  from, 20%, 53%, 80%, to {\n    transform: scale(0.8);\n    opacity: 1;\n  }\n\n  40%, 43% {\n    transform: scale(1.3);\n    opacity: 0.4;\n  }\n\n  70% {\n    transform: scale(1.2);\n    opacity: 0.7;\n  }\n\n  90% {\n    transform: scale(1.1);\n    opacity: 0.8;\n  }\n"])));
var Container$5 = styled__default['default'].div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  height: ", ";\n  width: ", ";\n  position: relative;\n"], ["\n  height: ", ";\n  width: ", ";\n  position: relative;\n"])), function (props) { return props.width && props.width; }, function (props) { return props.width && props.width; });
var RotatingPancakeIcon = styled__default['default'](Icon$s)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s ease infinite;\n  transform: translate3d(0, 0, 0);\n  z-index: 1;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s ease infinite;\n  transform: translate3d(0, 0, 0);\n  z-index: 1;\n"])), bounce);
var Shadow = styled__default['default'].div(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  animation: ", " 2s ease infinite;\n  transform: translate3d(0, 0, 0);\n  height: 10px;\n  background-color: rgba(0,0,0, 0.18);\n  border-radius: 50%;\n  width: ", ";\n  position: absolute;\n  bottom: 0px;\n  z-index: 0;\n"], ["\n  animation: ", " 2s ease infinite;\n  transform: translate3d(0, 0, 0);\n  height: 10px;\n  background-color: rgba(0,0,0, 0.18);\n  border-radius: 50%;\n  width: ", ";\n  position: absolute;\n  bottom: 0px;\n  z-index: 0;\n"])), shadow, function (props) { return props.width && props.width; });
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React__default['default'].createElement(Container$5, { width: size * 0.5 + "px" },
        React__default['default'].createElement(RotatingPancakeIcon, { width: size * 0.5 + "px" }),
        React__default['default'].createElement(Shadow, { width: size * 0.5 + "px" })));
};
var templateObject_1$q, templateObject_2$d, templateObject_3$8, templateObject_4$6, templateObject_5$4;
...
var templateObject_1$o, templateObject_2$c, templateObject_3$7, templateObject_4$5, templateObject_5$3, templateObject_6, templateObject_7;
...
var getBorderRadius = function (_a) {
    var scale = _a.scale;
    return (scale === "md" ? "16px 16px 0 0" : scale === "ml" ? "16px 16px 0 0" : "24px 24px 0 0");
};
var getPadding = function (_a) {
    var scale = _a.scale;
    return (scale === "md" ? "8px" : scale === "ml" ? "12px 12px 0 0" : "16px");
};
...
var Tag = function (_a) {
    ...
    return (React__default['default'].createElement(StyledTag, __assign({}, props),
        ...
        React__default['default'].createElement(Text, { fontSize: "14px" }, children),
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #ef52d1, 0px 0px 0px 4px rgba(238, 84, 209, 0.4)",
...
var templateObject_1$i, templateObject_2$8, templateObject_3$5, templateObject_4$4;
...
var Icon$7 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { fill: "none", d: "M18.3033333,6.3400002c-0.0100002-0.0599999-0.0200005-0.1200004-0.0300007-0.1800003" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { fill: "none", d: "M6.4266853,14.7600002c0.04,0.1399994,0.0999999,0.2699995,0.1700001,0.4099998v0.0100002" }))),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M6.103353,12.7599678h0.0100098v-0.0799561C6.103353,12.70998,6.103353,12.7299995,6.103353,12.7599678z\n    \t\t M6.3033042,11.3199654c-0.0099487-0.0299683-0.3999634-1.2699585-0.5299683-2.7799683\n    \t\tC5.7133384,7.769978,5.7133384,6.9300122,5.8733115,6.1599927C5.9033408,5.98,6.103353,5.8700147,6.2733359,5.939961\n    \t\tC6.1533408,5.8899732,6.0333457,5.8499951,5.9233603,5.8099561C5.6933188,6.6700025,5.6833091,7.6499829,5.7533164,8.5599556\n    \t\tc0.1000366,1.1800537,0.3500366,2.2400513,0.5200195,2.7600098c0.0299683,0.0900269,0.039978,0.1600342,0.0499878,0.2600098\n    \t\tc0.0100098-0.0299683,0.0100098-0.0599976,0.0200195-0.0800171C6.3333335,11.4399605,6.3233237,11.3799629,6.3033042,11.3199654z\n    \t\t M7.8233237,16.7899971L7.813314,16.8000069c0.0800171,0.0799561,0.1700439,0.1499634,0.2600093,0.2099609\n    \t\tC7.9833579,16.9300117,7.9033408,16.8600044,7.8233237,16.7899971z M10.623311,18.2199898\n    \t\tc-0.1099854-0.0200195-0.2199707-0.039978-0.3299561-0.0700073c0.1799927,0.0499878,0.3699951,0.0900269,0.5599976,0.1300049\n    \t\tC10.7733355,18.2599678,10.7033281,18.2400093,10.623311,18.2199898z M10.8533525,7.7899976v0.0100098l0.0199585-0.0100098\n    \t\tC10.8633623,7.7899976,10.8633623,7.7899976,10.8533525,7.7899976z M16.123312,6.7099805\n    \t\tc-0.1099854,0.0599976-0.2299814,0.1199951-0.3399668,0.1900024c0,0,0,0,0.0100098,0.0100098\n    \t\tc0.1099854-0.0599976,0.2299814-0.1300049,0.3399668-0.1900024c0.3099976-0.1699829,0.6199951-0.3200073,0.9100342-0.4500122\n    \t\tC16.7533169,6.3899732,16.4333096,6.5399976,16.123312,6.7099805z M18.1933193,5.8099561\n    \t\tc-0.1499634,0.0500488-0.3299561,0.1100464-0.5100098,0.2000122C17.7533169,5.98,17.8133144,5.9599805,17.873312,5.939961\n    \t\tc0.1500244-0.0599976,0.3300171,0.0200195,0.3900146,0.1700439C18.2433071,6.0099683,18.2233486,5.9099927,18.1933193,5.8099561z" })),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("ellipse", { cx: "10.0296221", cy: "12.1669502", rx: "1.15625", ry: "1.40625" }),
            React__default['default'].createElement("ellipse", { cx: "14.1233721", cy: "12.1669502", rx: "1.15625", ry: "1.40625" }),
            React__default['default'].createElement("path", { d: "M12.8977861,13.9452705h-1.5810547c-0.1523438,0-0.2929688,0.0859375-0.3759766,0.2285156\n    \t\tc-0.0976562,0.1708984-0.0976562,0.3818359,0,0.5507812l0.1572266,0.2714844\n    \t\tc0.2265625,0.3916016,0.6044922,0.6240234,1.0117188,0.6240234c0.0019531,0,0.0048828,0,0.0068359,0\n    \t\tc0.4111328-0.0029297,0.7900391-0.2421875,1.0136719-0.6396484l0.1464844-0.2607422\n    \t\tc0.0947266-0.1699219,0.09375-0.3808594-0.0048828-0.5488281C13.1888018,14.0292549,13.0491533,13.9452705,12.8977861,13.9452705z" })),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "M19.833334,14.749958h0.7800293c0.5499878,0,1-0.4499512,1-1c0-0.5499878-0.4500122-1-1-1h-0.5700073\n    \t\t\tc0-0.039978-0.0100098-0.0799561-0.0100098-0.1199951c-0.0100098-0.1599731-0.0200195-0.3200073-0.0400391-0.4799805\n    \t\t\tc-0.0199585-0.2000122-0.0599976-0.4099731-0.0999756-0.6099854c0.2999878-1.1300049,1.039978-4.4199824,0.0200195-6.9700313\n    \t\t\tc-0.210022-0.5199585-0.7000122-0.8499756-1.2300415-0.8899536C18.5033169,3.6599927,18.3133144,3.6700025,18.123312,3.73\n    \t\t\tc-0.7799683,0.2399902-3.0499887,1.0100098-4.750001,2.3900146c-0.0499878-0.0200195-0.0999756-0.0200195-0.1499634-0.0300293\n    \t\t\tc-0.6300049-0.0900269-1.2200317-0.0999756-1.7600098-0.0499878c-0.210022,0.0199585-0.4100342,0.039978-0.6099854,0.0800171\n    \t\t\tC9.1933184,4.9499707,6.8033042,3.9699903,6.0233359,3.73C5.8333335,3.6700025,5.6533408,3.6599927,5.4633384,3.6800122\n    \t\t\tc-0.5200195,0.039978-1.0200195,0.3699951-1.2299805,0.8899536c-1.0200198,2.5500488-0.2800295,5.8400264,0.0199585,6.9700313\n    \t\t\tc-0.039978,0.2000122-0.0700073,0.4099731-0.0999756,0.6099854c-0.0200195,0.1599731-0.0300293,0.3200073-0.039978,0.4799805\n    \t\t\tc0,0.0400391-0.0100098,0.0800171-0.0100098,0.1199951H3.5333455c-0.5499878,0-1,0.4500122-1,1c0,0.5500488,0.4500122,1,1,1\n    \t\t\tH4.313314c0.0100098,0.0300293,0.0200195,0.0500488,0.0300293,0.0700073\n    \t\t\tc0.0999756,0.3600464,0.2099609,0.7000122,0.3599854,1.0300293l-0.7100222,0.25\n    \t\t\tc-0.5199585,0.1799927-0.789978,0.75-0.6099854,1.2799683c0.1500244,0.4100342,0.5300293,0.6600342,0.9500124,0.6600342\n    \t\t\tc0.1099854,0,0.2199707-0.0200195,0.3300171-0.
.0799561\n    \t\t\tc0.0099487-0.1000366,0.0199585-0.2000122,0.039978-0.2900391c0.0100098-0.0800171,0.0100098-0.1799927,0.0299683-0.2600098\n    \t\t\tl0.1400146-0.539978c0-0.0100098,0-0.0100098,0-0.0100098c-0.0100098-0.0999756-0.0200195-0.1699829-0.0499878-0.2600098\n    \t\t\tC6.103353,10.8000069,5.853353,9.7400093,5.7533164,8.5599556C5.6833091,7.6499829,5.6933188,6.6700025,5.9233603,5.8099561\n    \t\t\tC6.0333457,5.8499951,6.1533408,5.8899732,6.2733359,5.939961c0.5100098,0.1800537,1.1199951,0.4400024,1.7399898,0.7800293\n    \t\t\tc0.1400146,0.0800171,0.2700195,0.1500244,0.4100342,0.2299805c-0.4100342,0.210022-0.6600337,0.3900146-0.690002,0.4200439\n    \t\t\tC7.2933555,7.6999707,7.2033286,8.3199654,7.5333457,8.7599678s0.9599605,0.5400391,1.3999629,0.210022\n    \t\t\tc0.1199951-0.0900269,2.960022-2.1300044,6.5500488,0.0499878c0.1599731,0.1000366,0.3399658,0.1500244,0.5199594,0.1500244\n    \t\t\tc0.3300171,0,0.6600342-0.1700439,0.8500366-0.4800415c0.289978-0.4799805,0.1399536-1.0899653-0.3300171-1.3800044\n    \t\t\tc-0.25-0.1499634-0.4899902-0.2799683-0.7299814-0.3999634c-0.0100098-0.0100098-0.0100098-0.0100098-0.0100098-0.0100098\n    \t\t\tc0.1099854-0.0700073,0.2299814-0.1300049,0.3399668-0.1900024c0.3099976-0.1699829,0.6300049-0.3200073,0.9200439-0.4400024\n    \t\t\tc0.1499634-0.0599976,0.2999878-0.1199951,0.4400024-0.1799927c0.0699463-0.0300293,0.1300049-0.0599976,0.1999512-0.0800171\n    \t\t\tc0.1800537-0.0899658,0.3600464-0.1499634,0.5100098-0.2000122c0.0300293,0.1000366,0.0499878,0.2000122,0.0700073,0.3000488\n    \t\t\tc0.0100098,0.0100098,0.0100098,0.0299683,0.0100098,0.039978v0.0100098h0.0100098\n    \t\t\tc0.0100098,0.0599976,0.0199585,0.1199951,0.0199585,0.1799927c0.0200195,0.0599976,0.0300293,0.1199951,0.0300293,0.1799927\n    \t\t\tC18.4333096,7.189961,18.4233608,7.8899732,18.373312,8.5399971z" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "M10.873311,7.7899976l-0.0199585,0.0100098V7.7899976C10.8633623,7.7899976,10.8633623,7.7899976,10.873311,7.7899976z" })))));
};
...
var LinkLabel = styled__default['default'](Text)(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  ", ";\n  flex-grow: 1;\n  transition: opacity 0.4s;\n"], ["\n  ",
    ";\n  flex-grow: 1;\n  transition: opacity 0.4s;\n"])), function (_a) {
...
var templateObject_1$f, templateObject_2$7, templateObject_3$4, templateObject_4$3;
...
var DropdownContent = styled__default['default'].div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  padding: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  border-radius: 0px 0px 12px 12px;\n  top: 60px;\n  position: absolute;\n  width: 100%;\n"], ["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  padding: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  border-radius: 0px 0px 12px 12px;\n  top: 60px;\n  position: absolute;\n  width: 100%;\n"])), function (_a) {
    ...
    var isOpen = _a.isOpen, isPushed = _a.isPushed;
    return (isOpen && isPushed ? "8px 0px " : '0px');
}, function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.shadows.dropDown;
});
var Dropdown = function (_a) {
    var label = _a.label, status = _a.status, icon = _a.icon, isPushed = _a.isPushed, isMobile = _a.isMobile, pushNav = _a.pushNav, _b = _a.initialOpenState, initialOpenState = _b === void 0 ? false : _b, children = _a.children, className = _a.className, isActive = _a.isActive;
    ...
    return (React__default['default'].createElement(Container$4, { ref: ref, isMobile: isMobile ? true : false },
...
var Container$3 = styled__default['default'].div(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  height: 100%;\n  align-items: center;\n  max-width: 1166px;\n  display: ", ";\n\n"], ["\n  display: flex;\n  flex-direction: row;\n  height: 100%;\n  align-items: center;\n  max-width: 1166px;\n  display: ", ";\n\n"])), function (_a) {
    var isMobile = _a.isMobile;
    return !isMobile ? "inherit" : 'none';
});
var PanelBody$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, { isMobile: isMobile }, links.map(function (entry) {
        ...
        if (entry.items) {
            ...
            return (React__default['default'].createElement(Dropdown, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://pancakeswap.info/token/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        React__default['default'].createElement(Text, { color: "textSubtle", bold: true, ml: "8px" }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var PanelFooter = function (_a) {
    ...
    if (!isPushed) {
        return (React__default['default'].createElement(Container$2, { isDark: isDark, isPushed: false },
    ...
    // </SettingsEntry>
    return (React__default['default'].createElement(Container$2, { isDark: isDark, isPushed: true },
        ...
        React__default['default'].createElement(LoginContainer, null, userBlock)));
};
var templateObject_1$b, templateObject_2$5, templateObject_3$3, templateObject_4$2, templateObject_5$2;

var Icons$1 = IconModule;
var blink = styled.keyframes(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  0%,  100% { transform: scaleY(1); }\n  50% { transform:  scaleY(0.1); }\n"], ["\n  0%,  100% { transform: scaleY(1); }\n  50% { transform:  scaleY(0.1); }\n"])));
var LogoWrapper = styled__default['default'].div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var LogoContainer = styled__default['default'].div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  justify-content: flex-start;\n  align-items: center;\n  font-size: 28px;\n  font-weight: 400;\n  display: flex;\n  color:  ", ";\n  flex-grow: 1;\n  transition: opacity 0.4s;\n  pointer-events: none;\n  ", ";\n\n  svg {\n    margin-bottom: 0px!important;\n  }\n"], ["\n  justify-content: flex-start;\n  align-items: center;\n  font-size: 28px;\n  font-weight: 400;\n  display: flex;\n  color:  ", ";\n  flex-grow: 1;\n  transition: opacity 0.4s;\n  pointer-events: none;\n  ",
    ";\n\n  svg {\n    margin-bottom: 0px!important;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return (theme.colors.text);
}, function (_a) {
...
styled__default['default'].img(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject([""], [""])));
var LogoText = styled__default['default'].div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  margin-left: 8px;\n"], ["\n  margin-left: 8px;\n"])));
var Logo = function (_a) {
    var isPushed = _a.isPushed; _a.togglePush; _a.isDark; var href = _a.href;
    var Icon = Icons$1['LogoIcon'];
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(LogoContainer, { isPushed: isPushed },
            React__default['default'].createElement(Icon, { width: "28px" }),
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(LogoWrapper, null,
        innerLogo,
        "Meow")) : (React__default['default'].createElement(LogoWrapper, null, innerLogo))));
};
...
var PanelHeader = function (_a) {
    ...
    if (!isPushed) {
        return (React__default['default'].createElement(Container$1, { isPushed: true },
            React__default['default'].createElement(IconButton, { className: "cog", variant: "text", onClick: function () { return pushNav(true); } },
                React__default['default'].createElement(Icon$1e, null))));
    }
    var homeLink = links.find(function (link) { return link.label === "Home"; });
    return (React__default['default'].createElement(Container$1, { isPushed: false },
        React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return pushNav(!isPushed); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" })));
};
...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel$1, { isPushed: isPushed, showMenu: showMenu },
        React__default['default'].createElement(PanelHeader, __assign({}, props)),
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null, links.map(function (entry) {
        ...
        if (entry.items) {
            var itemsMatchIndex = entry.items.findIndex(function (item) { return item.href === location.pathname; });
            var initialOpenState = entry.initialOpenState === true ? entry.initialOpenState : itemsMatchIndex >= 0;
            return (React__default['default'].createElement(Dropdown, { key: entry.label, isPushed: isPushed, isMobile: isMobile, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, isMobile: isMobile },
                    React__default['default'].createElement(MenuLink, { href: item.href },
                        React__default['default'].createElement(LinkLabelMemo, { isPushed: isPushed }, item.label),
                        item.status && (React__default['default'].createElement(LinkStatus, { color: item.status.color, fontSize: "14px" }, item.status.text))))); })));
...
var SideBar = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu },
...
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { width: "100%", variant: "tertiary", onClick: function () {
            ...
            onDismiss();
        }, style: { justifyContent: "space-center" }, mb: mb, id: "wallet-connect-" + title.toLocaleLowerCase() },
...
var Grid = styled__default['default'].div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  display: grid;\n  gap: 16px;\n  width: 100%;\n  grid-template-columns: repeat(2, 1fr);\n\n  button {\n    display: flex;\n    flex-direction: column;\n    min-height: 91px;\n    background-color: ", ";\n    margin: 0px;\n    svg {\n      margin-bottom: 8px;\n    }\n  }\n"], ["\n  display: grid;\n  gap: 16px;\n  width: 100%;\n  grid-template-columns: repeat(2, 1fr);\n\n  button {\n    display: flex;\n    flex-direction: column;\n    min-height: 91px;\n    background-color: ", ";\n    margin: 0px;\n    svg {\n      margin-bottom: 8px;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React__default['default'].createElement(Grid, null, connectors.map(function (entry, index) { return (React__default['default'].createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); })),
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { hideBorder: true, scale: "md", fullWidth: true, variant: "palePrimary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(Button, { scale: "md", fullWidth: true, onClick: function () {
...
styled__default['default'].nav(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
...
var ZINDEX = 1000;
var TOP_POSITION = 20; // Initial position from the top
