...
export const Default: React.FC = () => {
  ...
  return (
    <>
      ...
      <Row>
        <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="ms" ml="24px">
          <ButtonMenuItem>Button 1</ButtonMenuItem>
          <ButtonMenuItem>Button 2</ButtonMenuItem>
          <ButtonMenuItem>Button 3</ButtonMenuItem>
          <ButtonMenuItem>Button 4</ButtonMenuItem>
      ...
      <Row>
        <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="ms" variant="subtle" ml="24px">
          <ButtonMenuItem>Button 1</ButtonMenuItem>
          <ButtonMenuItem>Button 2</ButtonMenuItem>
          <ButtonMenuItem>Button 3</ButtonMenuItem>
          <ButtonMenuItem>Button 4</ButtonMenuItem>
      ...
      <Row>
        <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="xs" variant="subtle" ml="24px">
          <ButtonMenuItem>Button 1</ButtonMenuItem>
          <ButtonMenuItem>Button 2</ButtonMenuItem>
          <ButtonMenuItem>Button 3</ButtonMenuItem>
          <ButtonMenuItem>Button 4</ButtonMenuItem>
